...
public class map_makanan2 extends Fragment implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng marker = new LatLng(-7.427892,109.265958);
        googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(marker,18));
        googleMap.addMarker(new MarkerOptions().title("Jenang Jaket").position(marker));
