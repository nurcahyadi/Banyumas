...
public class map_event1 extends Fragment implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng marker = new LatLng(-7.435109,109.250164);
        googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(marker,18));
        googleMap.addMarker(new MarkerOptions().title("Hackathon Banyumas").position(marker));
